          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item text-center">
                <a class="navbar-brand ms-1 fw-bolder" href="{{ route ('login')}}">
      ...
      <div class="container text-light">
        <div class="row justify-content-center">
          <div class="col-md-6">
            ...
            <form method="POST" action="{{ route('forgot.password.link') }}" class="mb-5">
              @if (Session::get('fail'))
            ...
            <div class="row mt-3">
              <p class="small text-center">Already have an account? <a href="#" class="text-light fw-bold">Login</a></p>
            </div> --}}
          </div>
        </div>
      </div>
