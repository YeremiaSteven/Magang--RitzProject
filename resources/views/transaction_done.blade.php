...
@endif
    <div class="container-fluid" >
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav nav-tabs mx-auto">
                  <li class="nav-item">
                    <a class="nav-link" href="/transaction_user/ongoing"
                      >Ongoing</a
                    >
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="/transaction_user/done">Done</a>
                  </li>
                </ul>
              </div>
            </div>
      ...
      {{-- <div class="row justify-content-center mb-5" style="background: white;">
        <div class="col-md-10">
      ...
      @if ($u->ipayment_status != "PENDING" && $u->itracking_status == 2 || $u->itracking_status == 3)
