  ...
  @include('sweetalert::alert')
    ...
    <section id="navbar">
      <nav class="navbar navbar-expand-lg">
          ...
          <div class="container-fluid">
            <img src="{{asset('assets/img/logo_tokobiru.png')}}" alt="Logo Tokobiru" class="img-fluid mx-auto d-block mb-2">
            <a class="navbar-brand ms-1 fw-bolder" href="/home">{{$nama_web->vvalue}}</a>
      ...
      <section id="footer">
        ...
        <footer class="text-center text-lg-start text-muted pt-1" style="background-color: #d7e3f9;">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <h6 class="text-uppercase fw-bold mb-4">
                    <img src="{{asset('assets/img/logo_tokobiru.png')}}" alt="Logo Tokobiru" style="width: 12%;"> {{$nama_web->vvalue}}
                  </h6>
                  <p>
          ...
          <div class="text-center p-3 bg-light">
            © 2023 Copyright:
            <a class="text-reset fw-bold" href="#"><img src="{{asset('assets/img/logo_tokobiru.png')}}" alt="Logo Tokobiru" class="img-fluid"> {{$nama_web->vvalue}}</a>
          </div>
          <!-- Copyright -->
        </footer>
        <!-- Footer -->
	...
	<div class="modal-dialog">
	  <div class="modal-content">
		...
		<div class="modal-body">
			<form action="{{ url('member_request')}}" method="POST">
                @csrf
