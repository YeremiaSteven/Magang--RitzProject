        ...
        <ul class="nav navbar-nav nav-pills flex-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 fw-bold" id="nav_accordion">
          ...
          <li class="nav-item has-submenu">
            ...
            <ul class="submenu collapse">
              ...
              <li style="list-style-type: none"><a class="nav-link" href ="/master/holiday">Holiday</a></li>
              <li style="list-style-type: none"><a class="nav-link" href ="/master/operational">Operational Hour</a></li>  
            </ul>
          </li>
          <li class="nav-item has-submenu">
            <a href="#" class="nav-link px-sm-0 px-2">
